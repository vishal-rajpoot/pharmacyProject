...
const Middle = ({appointment,staff,staffCount,appointmentCount}) => {
  return (
    <div>
        ...
        <div class="overflow-x-auto w-[44rem]">
          <div className=" ml-10">
            ...
            <table class="table-auto h-28 w-full">
              ...
              <tbody>
                {
                    appointmentCount>0? appointment.map((node)=>{
                  ...
                  <td>
                    <div className="flex justify-center">09:15-09:45am</div>
                  </td>
                  <th>
                    ...
                    }): <div><h1 style={{color:"#777", textAlign:"center", margin:"55px",mirginLeft:"200px",paddingLeft:"130px"}}>No Appointment Found</h1></div>
                }
                {/* <tr className="text-gray-600">
                  <td>
                    <div class="flex items-center space-x-3">
        ...
        <div class="overflow-x-auto w-[20rem]">
          <div className="">
            ...
            <table class="table-auto h-28 w-full">
              ...
              <tbody>
                {staffCount>0? staff.map((node) => {
                  return (
                    <tr className="text-gray-600" key={node.objectId}>
                      <td>
                        <div class="flex items-center space-x-3">
                          <div class="avatar ml-3">
                            <div class="mask mask-squircle w-6 h-6">
                      ...
                      <td className="flex justify-center">{node.role}</td>
                    </tr>
                  );
                }):<div><h1 style={{color:"#777", textAlign:"center", margin:"55px"}}>No Staff Found</h1></div>
                }
                {/* <tr className='text-gray-600'>
                                    <td className=''>
